...
?>
	...
	?>
		...
		if (isset($row->images[0])) {
			echo "<div class='center'><a href='".$linkTarget."'><img src='".$baseurl."images/com_adsmanager/ads/".$row->images[0]->$imagetype."' alt='".htmlspecialchars($row->ad_headline)."' border='0' /></a>";
		}
		else
		{
