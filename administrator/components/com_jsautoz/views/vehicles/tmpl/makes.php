		...
		<td width="100%" valign="top">
			...
			<table>
				<tr>
					...
					<td> <input type="text" name="filter_mk_title" id="filter_mk_title" value="<?php if(isset($this->lists['maketitle'])) echo $this->lists['maketitle']; ?>"/></td>
					...
					<td>
						<button onclick="this.form.getElementById('filter_mk_title').value='';this.form.getElementById('sortby').value='';this.form.submit();"><?php echo JText::_( 'Reset' ); ?></button>
					</td>
				</tr>
			</table>
			...
			for ($i=0, $n=count( $this->items ); $i < $n; $i++)
				{
					...
					$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editvehiclemake&cid[]='.$row->id);
					?>
					<tr valign="top" class="<?php echo "row$k"; ?>">
						...
						<td align="center">
							<?php 
							if($row->status == 1){	?>
								<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','unpublishvehiclemake')">
									<img src="../components/com_jsautoz/images/tick.png" width="16" height="16" border="0" alt="<?php echo JText::_( 'PUBLISH' ); ?>" /></a>
							<?php }else{	?>
								<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','publishvehiclemake')">
									<img src="../components/com_jsautoz/images/publish_x.png" width="16" height="16" border="0" alt="<?php echo JText::_( 'UNPUBLISH' ); ?>" /></a>
							<?php }	?>
						</td>
                                                <td align="center">
                                                        <?php $mlink = 'index.php?option='.$this->option.'&task=view&layout=models&mid='.$row->id;?>
                                                        <a href="<?php echo $mlink; ?>">
                                                        <?php echo JText::_('MODELS'); ?></a>
                                                 </td>
					</tr>
					<?php
					$k = 1 - $k;
			...
			<input type="hidden" name="layout" value="makes">
