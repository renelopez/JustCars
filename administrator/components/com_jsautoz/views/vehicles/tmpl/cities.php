	...
	<tr>
		...
		<td width="100%" valign="top">
			...
			<table class="adminlist" border="0">
				<thead>
					...
					?>
						...
						<a href="index.php?option=com_jsautoz&task=view&layout=counties&sd=<?php echo $statecode; ?>" ><?php echo JText::_('COUNTIES'); ?> </a>
					</td></tr>
					<tr>
						<th width="20">
			...
			$k = 0;
				...
				$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editvehiclecity&cid[]='.$row->id);
				?>
			...
			<input type="hidden" name="co" value="<?php if($countycode) echo $countycode; ?>" />
