		...
		<td width="100%" valign="top">
			...
			<table class="adminlist" border="0">
				<thead>
					<tr>
						...
						<th><?php echo JText::_('COUNTIES'); ?></th>
					</tr>
				</thead>
			<?php
			...
			$k = 0;
				...
				//$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=edit&cid[]='.$row->id);
                                $link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editvehiclestate&cid[]='.$row->id);
				?>
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td><a href="index.php?option=com_jsautoz&task=view&layout=counties&sd=<?php echo $row->code; ?>"><?php echo JText::_('COUNTIES'); ?></a></td>
				</tr>
				<?php
				$k = 1 - $k;
			}
