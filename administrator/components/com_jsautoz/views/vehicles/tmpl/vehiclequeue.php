...
defined('_JEXEC') or die('Restricted access');
 global $mainframe;
JRequest :: setVar('layout', 'vehiclequeue');
$layoutName = JRequest :: getVar('layout', '');
$_SESSION['cur_layout']='vehiclequeue';
		...
		<td width="100%" valign="top">
			...
			<table>
				<tr>
					...
					<td><?php echo JText::_('CONDITON');?>:</td>
				...
				for ($i=0, $n=count( $this->vehicles ); $i < $n; $i++)
					{	
						...
						<tr valign="top" class="<?php echo "row$k"; ?>">
							...
							<td align="center">
								<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','publishvehicle')">
								<img src="../components/com_jsautoz/images/tick.png" width="16" height="16" border="0" alt="<?php echo JText::_( 'PUBLISH' ); ?>" /></a>
								&nbsp;&nbsp; - &nbsp;&nbsp
								<a href="javascript:void(0);" onclick="return listItemTask('cb<?php echo $i;?>','unpublishvehicle')">
					...
					<input type="hidden" name="layout" value="vehiclequeue">
