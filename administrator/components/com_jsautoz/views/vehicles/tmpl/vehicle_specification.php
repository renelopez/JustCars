...
?>
    ...
    <?php $divclass = array('odd', 'even'); $k=1 ?>
<div class="<?php echo $divclass['0']; ?>" id="automaindiv">
	<div id="sub_heading">
		<?php echo JText::_('SPECIAL_FEATURES'); ?>
	</div>
<div class="<?php echo $divclass[$k];$k=1-$k; ?> auto_vsmain ">
<div class="section_heading"  id="leftalign">
...
<?php /*
    <div id="auto_adminvehiclewraper">
    <h1 ><?php echo JText::_('SPECIAL_FEATURES'); ?></h1>
<div id="auto_vsmain" style="background:none;">
<strong><?php echo JText::_('FEATURE_IN_VEHICLE');?></strong>
    <table cellpadding="3" cellspacing="0" border="0" width="100%">
      <?php
      $colperrow=4;
      $colwidth = round(100/$colperrow,1);
      ...
      $colcount=0;?>
            <tr class="<?php echo $divclass[$k];$k= 1-$k; ?>">
                <td>
                    <table cellpadding="3" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td colspan="<?php echo $colperrow; ?>" valign="top" align="left" class=""><h1><?php echo JText::_('BODY'); ?></h1></td>
                            </tr>
                        <tr >
                            <?php
                            if($this->vehicleoptions->door2 == 1) {
            ...
            <tr class="<?php echo $divclass[$k];$k= 1-$k; ?>">
                <td>
                    <table cellpadding="3" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td colspan="<?php echo $colperrow; ?>" valign="top" align="left" class=""><h1><?php  echo JText::_('DRIVE_TRAIN'); ?></h1></td>
                        </tr>
                         <tr>
                            <?php
                            if($this->vehicleoptions->wheeldrive2== 1){
            ...
            <tr class="<?php echo $divclass[$k];$k= 1-$k; ?>">
                <td>
                    <table cellpadding="3" cellspacing="0" border="0" width="100%">
                        <tr>
                            <td colspan="<?php echo $colperrow; ?>" valign="top" align="left" class=""><h1><?php  echo JText::_('EXTERIOR'); ?></h1></td>
                        </tr>
                         <tr>
                            <?php
                            if($this->vehicleoptions->alloywheels== 1){
                ...
                <tr class="<?php echo $divclass[$k];$k= 1-$k; ?>">
                    <td>
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td colspan="<?php echo $colperrow; ?>" valign="top" align="left" class=""><h1><?php  echo JText::_('INTERIOR'); ?></h1></td>
                            </tr>
                            <tr>
                                <?php
                                if($this->vehicleoptions->ndrowbucketseats2== 1){
                ...
                <tr class="<?php echo $divclass[$k];$k= 1-$k; ?>">
                    <td>
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td colspan="<?php echo $colperrow; ?>" valign="top" align="left" class=""><h1><?php  echo JText::_('ELECTRONICS'); ?></h1></td>
                            </tr>
                            <tr>
                                <?php
                                if($this->vehicleoptions->alarm== 1){
                ...
                <tr class="<?php echo $divclass[$k];$k= 1-$k; ?>">
                    <td>
                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                            <tr>
                                <td colspan="<?php echo $colperrow; ?>" valign="top" align="left" class=""><h1><?php  echo JText::_('SAFETY_FEATURES'); ?></h1></td>
                            </tr>
                            <tr>
                                <?php
                                if($this->vehicleoptions->antilockbrakes== 1){
                        ...
                        <td>
                                <table cellpadding="3" cellspacing="0" border="0" width="100%">
                                        ...
                                        <?php foreach($this->vehicleoption as $field){
                                            switch ($field->field) { 
                                                case "section_userfields":
                                                echo '<td colspan="'.$colperrow.'" valign="top" align="left" ><h1>'.$field->fieldtitle.'</h1></td>';
