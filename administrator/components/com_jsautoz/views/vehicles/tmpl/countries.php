		...
		<td width="100%" valign="top">
			...
			$k = 0;
				...
				//$link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=edit&cid[]='.$row->id);
                                $link = JFilterOutput::ampReplace('index.php?option='.$this->option.'&task=editvehiclecountry&cid[]='.$row->id);
				?>
				<tr valign="top" class="<?php echo "row$k"; ?>">
					...
					<td><a href="index.php?option=com_jsautoz&task=view&layout=states&ct=<?php echo $row->code; ?>"><?php echo JText::_('STATES'); ?></a></td>
				</tr>
				<?php
				$k = 1 - $k;
			}
