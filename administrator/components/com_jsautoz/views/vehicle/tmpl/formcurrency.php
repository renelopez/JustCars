...
Joomla.submitbutton = function(task){
        if (task == ''){
                ...
                if (task == 'savecurrency' || task == 'savecurrencysave' || task == 'savecurrencyandnew'){
...
function submitbutton(pressbutton) {
	...
	if(pressbutton == 'savecurrency' || pressbutton == 'savecurrencysave' || pressbutton == 'savecurrencyandnew'){
		returnvalue = validate_form(document.adminForm);
	}else returnvalue  = true;
...
<table width="100%" >
	...
	<tr class="row1">
		<td width="20%" valign="top"><label id="titleymsg" for="title"><?php echo JText::_('TITLE'); ?></label>&nbsp;<font color="red">*</font></td>
		  <td width="60%"><input class="inputbox required" type="text" name="title" size="40" maxlength="255" value="<?php if(isset($this->currency)) echo $this->currency->title; ?>" />
        </td>
      </tr>
	<tr class="row0">
		<td width="20%" valign="top"><label id="titleymsg" for="title"><?php echo JText::_('SYMBOL'); ?></label>&nbsp;<font color="red">*</font></td>
		  <td width="60%"><input class="inputbox required" type="text" name="symbol" size="40" maxlength="255" value="<?php if(isset($this->currency)) echo $this->currency->symbol; ?>" />
        </td>
      </tr>
      <tr>
	<tr class="row1">
		<td valign="top"><label id="statusmsg" for="status"><?php echo JText::_('PUBLISHED'); ?></label></td>
		  <td><input type="checkbox" name="status" value="1" <?php if(isset($this->currency))  {if ($this->currency->status == '1') echo 'checked';} ?>/>
		  </td>
      </tr>
	<tr><td colspan="2" height="10"></td></tr>
	<tr class="row0">
