...
class AdsmanagerControllerContents extends TController
{
	...
	function save($src=null, $orderingFilter = '', $ignore = '')
	{
		...
		{
			case 'apply':
				$app->redirect( 'index.php?option=com_adsmanager&c=contents&task=edit&id='.$content->id, JText::_('ADSMANAGER_CONTENT_SAVED') );
				break;
		
			case 'save2new':
				$app->redirect( "index.php?option=com_adsmanager&c=contents{$extra}&task=add", JText::_('ADSMANAGER_CONTENT_SAVED') );
				break;
