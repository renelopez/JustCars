...
class AdsmanagerControllerCategories extends TController
{
	...
	function save()
	{
		...
		{
			case 'apply':
				$app->redirect( 'index.php?option=com_adsmanager&c=categories&task=edit&id='.$category->id, JText::_('ADSMANAGER_CATEGORY_SAVED') );
				break;
		
			case 'save2new':
				$app->redirect( 'index.php?option=com_adsmanager&c=categories&task=add', JText::_('ADSMANAGER_CATEGORY_SAVED') );
				break;
