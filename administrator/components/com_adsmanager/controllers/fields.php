...
class AdsmanagerControllerFields extends TController
{
	...
	function save()
	{
		...
		{
			case 'apply':
				$app->redirect( 'index.php?option=com_adsmanager&c=fields&task=edit&cid='.$field->fieldid, JText::_('ADSMANAGER_FIELD_SAVED') );
				break;
		
			case 'save2new':
				$app->redirect( 'index.php?option=com_adsmanager&c=fields&task=add', JText::_('ADSMANAGER_FIELD_SAVED') );
				break;
