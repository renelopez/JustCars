...
class AdsmanagerControllerColumns extends TController
{
	...
	function save()
	{
		...
		{
			case 'apply':
				$app->redirect( 'index.php?option=com_adsmanager&c=columns&task=edit&cid[]='.$column->id, JText::_('ADSMANAGER_COLUMN_SAVED') );
				break;
		
			case 'save2new':
				$app->redirect( 'index.php?option=com_adsmanager&c=columns&task=add', JText::_('ADSMANAGER_COLUMN_SAVED') );
				break;
