	...
	<td width="60%">
		<table class="adminform">
			...
			<tr>
				...
				<input type="radio" name="options_common_edit_admin_only" value="0" <?php if (@$this->options->edit_admin_only == "0") echo "checked='checked'";?> /><?php echo JText::_('ADSMANAGER_NO')?><br/><br/>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				...
				<input type="radio" name="options_common_is_conditional_field" value="0" <?php if (@$this->options->is_conditional_field == "0") echo "checked='checked'";?> /><?php echo JText::_('ADSMANAGER_NO')?><br/><br/>
				</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
		...
		<div id="divValues" style="text-align:left;">
			...
			<div class="storage_values" id="storage_values_internal">
				...
				<input type="button" id="addfvalue" class="button" value="<?php echo JText::_('ADSMANAGER_ADD_FIELD_VALUE')?>" /><br/>
				<ul id="values">
		...
		<div id="divImagesValues" style="text-align:left;">
			<?php echo JText::_('ADSMANAGER_FIELD_VALUES_EXPLANATION');?>
			<input type="button" id="addivalue" class="button" value="<?php echo JText::_('ADSMANAGER_ADD_FIELD_VALUE')?>" /><br/>
			<ul id="values">
				<li class="ui-state-disabled"> 
					<span id='empty'>&nbsp;</span> 
		...
		<script type="text/javascript">
			...
			function addIValue(image,value) {
				...
				data = '<li class="ui-state-default"> \
					...
					?>
				if (image != "")
					image = '<?php echo JURI::root()?>/images/com_adsmanager/fields/'+image;
				data += '</select> \
						<img src="'+image+'" id="preview_'+imgcount+'"/> \
						<input type="text" name="vImagesValues[]" value="'+value+'"/> \
					    <span class="ui-icon ui-icon-cancel"></span> \
					    </li>';
				jQ('#divImagesValues  #values').append(data);
				jQ('#img_'+imgcount).change(function() {
					jQ('#divImagesValues #'+jQ(this).attr('previewid')).attr('src','<?php echo JURI::root()?>/images/com_adsmanager/fields/'+jQ(this).val());
				});
