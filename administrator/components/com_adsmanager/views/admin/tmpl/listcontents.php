...
<thead>
<tr>
	<th class="title hidden-phone" width="5"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count($this->contents); ?>);" /></th>
...
<?php
	...
	foreach($content->images as $img) {
		echo "<img width='50' height='50' src='".$this->baseurl."images/com_adsmanager/ads/".$img->thumbnail."?time=".time()."'>";
		echo '&nbsp;';  
	}
	?>
	</td>
