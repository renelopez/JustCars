        ...
        <div id="jsautoz_toppanel">
                        ...
                        ?>
                            <div class="autoz_topcurloc">
                                ...
                                <?php }elseif($sellerevisitoremail) {	?>
                                    ...
                                    <?php //if($this->adtype == 1){	?>
                                            <?php //echo $this->adtype; ?>
                                            <!--<a href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('CONTROL_PANNEL'); ?></a> > -->
                                            <?php //echo JText::_('FORM_NEW_VEHICLE'); ?>
                                    <?php //}else{ ?>
                                           <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>">
                                            <?php echo JText::_('CONTROL_PANNEL'); ?>
                                            </a> > 
                                            <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=vehiclelist&vemail=<?php echo $sellerevisitoremail;  ?>&Itemid=<?php echo $this->Itemid ?>">
                                            <?php echo JText::_('MY_VEHICLES'); ?></a> > 
                                            <?php echo JText::_('FORM_VEHICLE'); ?>
                                    <?php //} ?>
                                <?php }elseif($this->adtype == 1){	?>
                                    <?php echo JText::_('CUR_LOC'); ?> :  
                                    <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('CONTROL_PANNEL'); ?></a> > 
                                        <?php echo JText::_('FORM_NEW_VEHICLE'); ?>
                                <?php }elseif($this->adtype == 2){	?>
                                    <?php echo JText::_('CUR_LOC'); ?> :  <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('CONTROL_PANNEL'); ?></a> > <?php echo JText::_('FORM_USED_VEHICLE'); ?>
                                <?php }elseif($this->curloc == 1){	?>
                                    <?php echo JText::_('CUR_LOC'); ?> :  <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('CONTROL_PANNEL'); ?></a> > <?php echo JText::_('FORM_VEHICLE'); ?>
                                <?php }elseif($this->curloc == 2){	?>
                                        <?php echo JText::_('CUR_LOC'); ?> :  <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('CONTROL_PANNEL'); ?></a> > <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=vehiclelist&nadtype=1&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('MY_VEHICLES'); ?></a> >
                                         <?php echo JText::_('FORM_VEHICLE'); ?>
                                <?php }else{	?>
                                    <?php echo JText::_('CUR_LOC'); ?> : 
                                    <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=controlpannel&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('CONTROL_PANNEL'); ?></a> > 
                                    <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=vehiclelist&Itemid=<?php echo $this->Itemid ?>"><?php echo JText::_('MY_VEHICLES'); ?></a> > 
                                        <?php echo JText::_('FORM_VEHICLEs'); ?>
                                <?php }	?>
                            </div>
                    <?php } ?>
            </div>
            ...
            <div id="autoz_topheading">
                    <span id="autoz_topheading_text">
                            ...
                            <span id="autoz_topheading_text_center"><?php echo JText::_('FORM_VEHICLE'); ?></span>
                            <span id="autoz_topheading_text_right"></span>
                    </span>
            </div>
        </div>

<?php if ($this->canaddnewvehicle == 1) {  // add new Vehicles, in edit case always 1 ?>
    ...
    <form action="index.php" method="post" name="adminForm" id="adminForm" class="form-validate"  onSubmit="return myValidate(this);">
            ...
            <table cellpadding="3" cellspacing="0" border="0" width="100%">                           <!--Main Table Start-->
                ...
                foreach($this->fieldorderings as $field){
                    switch ($field->field) {
                            case "title": ?>
                                    <tr>
                                                    <td valign="top" align="right"><label id="titlemsg" for="title"><?php echo JText::_('TITLE'); ?></label>&nbsp;<font color="red">*</font></td>
                                                    <td><input  class="inputbox required" type="text" id="title" name="title" value="<?php if(isset($this->vehicle))echo $this->vehicle->title;?>"/></td>
                                    </tr>
                            <?php break;
                            case "vehicletypeid": ?>
                               <tr>
                            ...
                            case "makeid": ?>
                               <tr>
                                               <td valign="top" align="right"><label id="makeidmsg" for="makeid"><?php echo JText::_('MAKE'); ?></label>&nbsp;<?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                               <td><?php echo $this->lists['makes']; ?></td>
                               </tr>
                            <?php break;
                            case "modelid": ?>
                               <tr>
                                               <td valign="top" align="right"><label id="modelidmsg" for="modelid"><?php echo JText::_('MODEL'); ?></label>&nbsp;<?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                               <td id="vf_models"><?php echo $this->lists['models']; ?></td>
                               </tr>
                            <?php break;
                            case "conditionid": ?>
                               <?php if(isset($this->lists['conditions']) && ($this->lists['conditions']!="")){ ?>
                                    <tr>
                                        <td valign="top" align="right"><label id="modelidmsg" for="modelid"><?php echo JText::_('CONDITION'); ?></label>&nbsp;<?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                            ...
                            case "cylinderid": ?>
                                    <tr>
                                                    <td valign="top" align="right"><label id="cylinderidmsg" for="cylinderid"><?php echo JText::_('CYLINDER'); ?></label>&nbsp;<?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                            ...
                            case "loczip": ?>
                                    <tr>
                                                    <td valign="top" align="right"><label id="loczipmsg" for="loczip"><?php echo JText::_('LOCATION_ZIP'); ?></label><?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                                    <td id="vehicleform_loczip">
                                                             <?php
                                                            if ((isset($this->lists['zipcode'])) && ($this->lists['zipcode']!='')){
                                                                            echo $this->lists['zipcode'];
                                                            } else{ ?>
                                                        <input class="inputbox<?php if($field->required == 1) echo' required';?>" type="text" id="loczip" name="loczip" value="<?php if(isset($this->vehicle))echo $this->vehicle->loczip;?>"/>
                                                            <?php } ?>
                                                    </td>
                                    </tr>
                            <?php break;
                            case "mileages": ?>
                                    <tr>
                                        ...
                                        <td><input class="inputbox<?php if($field->required == 1) echo' required';?>"  size="15" type="text" id="mileages" name="mileages" value="<?php if(isset($this->vehicle))echo $this->vehicle->mileages;?>"/>
                                        <?php echo $this-> lists['mileagetypes']; ?></td>
                                    </tr>
                            <?php break;
                            case "price": ?>
                                    <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <input class="inputbox<?php if($field->required == 1) echo' required';?>" type="text" id="price" name="price" value="<?php if(isset($this->vehicle)) echo $this->vehicle->price; ?>"/>
                                                    </td>
                                    </tr>
                            <?php break;
                            case "exteriorcolor": ?>
                                    <tr>
                                                    ...
                                                    <td>
                                                        <?php /*<input id="color1"  name="exteriorcolor" type="text" value="<?php if(isset($this->vehicle))echo $this->vehicle->exteriorcolor;?>" class="iColorPicker" />
                                    ...
                                    <tr>
                                                   ...
                                                   <!-- </td>-->
                                                    <td>
                                                        ...
                                                        <br/><input type="text" id="longitude" name="longitude" value="<?php if(isset($this->vehicle)) echo $this->vehicle->longitude;?>"/><?php echo JText::_('LONGITUDE');?>
                                                        <br/><input type="text" id="latitude" name="latitude" value="<?php if(isset($this->vehicle)) echo $this->vehicle->latitude;?>"/><?php echo JText::_('LATITUDE');?>
                                                         <br/> <div id="coordinatebutton"><input type="button" rel="button"  class="button"  value="<?php echo JText::_('SET_MARKER_FROM_ADDRESS');?>" onclick="Javascript: loadMap(3,'country','state','county','city');"/></div>
                                                         <div id="coordinatebutton"><input type="button"  rel="button" class="button" value="<?php echo JText::_('GET_ADDRESS_FROM_MARKER');?>" onclick="Javascript: loadMap(2,'country','state','county','city');"/></div>
                                                    ...
                                                    <?php if ( $this->config['vf_editor'] == '1' ) { ?>
                                                            ...
                                                            <?php 	} else 	{?>
                                                                                    <tr>
                                                                                            ...
                                                                                            <td><textarea cols="" rows=""   class="inputbox<?php if($field->required == 1) echo' required';?>" id="description" name="description" ><?php if(isset($this->vehicle))echo $this->vehicle->description;?></textarea></td>
                                                                                    </tr>
                                                            <?php } ?>
                            <?php   } ?>
                       <?php break;?>
					...
					if ( $field->published == 1 ) {
						foreach($this->userfields as $ufield){
							if($field->field == $ufield[0]->id) {
								...
								echo '<input type="hidden" id="userfields_'.$k.'_id" name="userfields_'.$k.'_id"  value="'.$userfield->id.'"  />';
								echo '<input type="hidden" id="userdata_'.$k.'_id" name="userdata_'.$k.'_id"  value="'.$userdataid.'"  />';
								switch( $userfield->type ) {
									case 'text':
										echo '<input type="text" id="userfields_'.$k.'" name="userfields_'.$k.'" size="'.$userfield->size.'" value="'. $fvalue .'" '.$cssclass .$maxlength . $readonly . ' />';
										break;
									case 'emailaddress':
										echo '<input type="text" id="userfields_'.$k.'" name="userfields_'.$k.'" size="'.$userfield->size.'" value="'. $fvalue .'" '.$cssclass .$maxlength . $readonly . ' />';
										break;
									case 'date':
										$userfieldid = 'userfields_'.$k;
										$userfieldid = "'".$userfieldid."'";
										echo '<input type="text" id="userfields_'.$k.'" name="userfields_'.$k.'" readonly size="'.$userfield->size.'" value="'. $fvalue .'" '.$cssclass .$maxlength . $readonly . ' />';
										echo '<input type="reset" class="button" value="..." onclick="return showCalendar('.$userfieldid.',\'%Y-%m-%d\');"  />';
										break;
									case 'textarea':
										echo '<textarea name="userfields_'.$k.'" id="userfields_'.$k.'_field" cols="'.$userfield->cols.'" rows="'.$userfield->rows.'" '.$readonly.'>'.$fvalue.'</textarea>';
										break;
									case 'checkbox':
										echo '<input type="checkbox" name="userfields_'.$k.'" id="userfields_'.$k.'_field" value="1" '.  'checked="checked"' .'/>';
										break;
									case 'select':
										$htm = '<select name="userfields_'.$k.'" id="userfields_'.$k.'" >';
										if (isset ($ufield[2])){
                ...
                echo '<input type="hidden" id="userfields_total" name="userfields_total"  value="'.$k.'"  />';
					}
                    }
    }
		?>
                                <?php if($this->uid==0) { 
                                  ...
                                  if($this->config['captcha']==1) { ?>
                                    <tr>
                                                    <td valign="top" align="right"><label id="captchamsg" for="captcha"><?php echo JText::_('SPAM_CHECK'); ?></label><?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
       ...
       foreach($this->fieldorderings_options as $field){
          switch ($field->field) {
                                            ...
                                            <td>
                                                     <table cellpadding="3" cellspacing="0" border="0" width="100%">
                                                                    ...
                                                                    case "tirepressuremonitorsystem": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                                            <td width="<?php echo $colwidth; ?>"><input type='checkbox' name='tirepressuremonitorsystem' id='tirepressuremonitorsystem' value='1' <?php if(isset($this->vehicleoptions)) { echo ($this->vehicleoptions->tirepressuremonitorsystem== 1) ? "checked='checked'" : ""; } ?> /><label for="tirepressuremonitorsystem"><?php  echo JText::_('TIRE_PRESSURE_MONITOR_SYSTEM'); ?></label></td>
                                                                    <?php break;
                                        ...
                                        <tr>
                                                <td>
                                                        <table cellpadding="3" cellspacing="0" border="0" width="100%">
                                                                ...
                                                                <?php break;
                                                                  case "userfield1":if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++;  ?>
                                                                        <tr>
                                                                ...
                                                                <?php break;
                                                                case "userfield2": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield3": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield4": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield5": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield6": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield7": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield8": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++;  ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield9": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield10": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield11": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield13": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield14": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
                                                                ...
                                                                <?php break;
                                                                case "userfield15": if($colcount == $colperrow){ echo '</tr><tr>'; $colcount = 0; } $colcount++; ?>
            ...
            <hr style="float: left;width: 100%;height: 2px;background-color: #000">
            <table>
                                <?php if($this->cellerinfo == TRUE) { ?>
                                    <tr>
                                            <td>
                                                 <table cellpadding="3" cellspacing="0" border="0" width="100%">
                                                    <tr>
                                                        <td colspan="<?php echo $colperrow; ?>" valign="top" align="left"><b><?php  echo JText::_('CONTACT_INFORMATION'); ?></b></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="top" align="right"><label id="sellernamemsg" for="sellername"><?php echo JText::_('NAME'); ?></label><?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                                        <td><input class="inputbox required" type="text" id="sellername" name="sellername" value="<?php if(isset($this->vehicle))echo $this->vehicle->name; ?>"/></td>
                                                        <td valign="top" align="right"><label id="sellercellmsg" for="sellercell"><?php echo JText::_('CELL'); ?></label><?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                                        <td><input class="inputbox required" type="text" id="sellercell" name="sellercell" value="<?php if(isset($this->vehicle))echo $this->vehicle->cell; ?>"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td valign="top" align="right"><label id="sellerphonemsg" for="sellerphone"><?php echo JText::_('PHONE'); ?></label><?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                                        <td><input class="inputbox required" type="text" id="sellerphone" name="sellerphone" value="<?php if(isset($this->vehicle))echo $this->vehicle->phone; ?>"/></td>
                                                        <td valign="top" align="right"><label id="selleremailmsg" for="selleremail"><?php echo JText::_('EMAIL'); ?></label><?php if($field->required == 1){ echo '&nbsp;<font color="red">*</font>';} ?></td>
                                                        <td><input class="inputbox required validate-email" type="text" id="selleremail" name="selleremail" value="<?php if(isset($this->vehicle))echo $this->vehicle->email; ?>"/></td>
                                                    </tr>
                                                 </table>
                                            </td>
                                    </tr>
            ...
            <?php
                ...
                ?>
                			...
                			<input type="hidden" name="created" value="<?php echo $curdate; ?>" />
                                        <input type="hidden" name="id" value="<?php if(isset($this->vehicle)) echo $this->vehicle->vehicleid; ?>"/>
                                        <input type="hidden" name="vehicleid" value="<?php if(isset($this->vehicle)) echo $this->vehicle->vehkey; ?>"/> <?php // for Visitor ?>
                                        <input type="hidden" name="scid" value="<?php if(isset($this->vehicle)) echo $this->vehicle->infoid; ?>"/> <?php // SEller Contact id for edit for Visitor ?>
                                        ...
                                        <?php if($this->curloc) { ?> 
                                         ...
                                         <?php }else{ ?>
                                                <input type="hidden" name="adtype" value="<?php if($this->adtype=='') {if(isset($this->vehicle)) echo $this->vehicle->conditionid; }else{ echo $this->adtype;} ?>" />
                                             
                                             <?php } ?>   
                                        <input type="hidden" name="curloc" value="<?php echo $this->curloc; ?>" /> 
                                        <input type="hidden" name="semail" value="<?php echo $this->semail; ?>" /> 
                                        ...
                                        <input type="hidden" name="status" value="" />
                                                <tr>
                                                    <td colspan="2" valign="top" align="center">  <input type="submit" rel="button" value="<?php echo JText::_('SAVE_AND_UPLOADIMAGE') ?>" /></td>
                                            </tr>
...
<?php
} else{ // can not add new vehicle
	echo '<strong><font color="red">'.JText::_('VEHICLE_LIMIT_EXCEED').' <a anchor="anchor" href="index.php?option=com_jsautoz&view=seller&layout=packages&Itemid='.$this->Itemid.'">'.JText::_('SELLER_PACKAGES').'</a></font></strong>';
}
...
$(document).keydown(function(e) {
        ...
        if (e.keyCode == 27) {
            ...
            //alert(e.keyCode);
            //document.getElementById('iColorPicker').innerHTML = "";
            //window.close();
        }
    });
 ...
 //var m1 = createMarker(new google.maps.LatLng(12,10), "m1");
  }
</script>
