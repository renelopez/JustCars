...
<div>        <div id="jsautoz_toppanel">
			<div id="jsautoz_topsection">
				...
				<?php if ($this->config['navigation'] == 1) { ?>
					<div class="autoz_topcurloc">
						...
						<?php } else { ?>
						<?php echo JText::_('CUR_LOC'); ?> : <a anchor="anchor" href="index.php?option=com_jsautoz&view=buyer&layout=controlpannel&Itemid=<?php echo $this->Itemid; ?>"><?php echo JText::_('CONTROL_PANEL'); ?></a> > <?php echo JText::_('VEHICLES_BY_CITY'); ?>
						<?php } ?>
					</div>
				<?php } ?>
            </div>
			...
			<div id="autoz_topheading">
				<span id="autoz_topheading_text">
					...
					<span id="autoz_topheading_text_center"><?php echo JText::_('VEHICLES_BY_CITY'); ?></span>
            ...
            <div id="auto_vmakestitle">
                ...
                <table cellpadding="0" cellspacing="0" border="" width="100%" >
                    <tr class="vehiclesby_data">
                            <?php foreach ($this->vehiclebycities AS $city) { ?>
                                <?php if ($city->totalvehiclelbycity) { ?>
                                <td >
                                            <?php $lnks = 'index.php?option=com_jsautoz&view=buyer&layout=listvehicles&country=' . $city->countrycode . '&state=' . $city->statecode . '&county=' . $city->countycode . '&city=' . $city->code . '&cl=2&Itemid='.$this->Itemid; ?>
                                    <a anchor="anchor" href="<?php echo $lnks; ?>" ><?php echo $city->name . '(' . $city->totalvehiclelbycity . ')'; ?>
                                    </a>
                                </td>
