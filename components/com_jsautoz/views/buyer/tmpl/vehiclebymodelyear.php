        ...
        <div id="jsautoz_toppanel">
			<div id="jsautoz_topsection">
				...
				<?php if ($this->config['navigation'] == 1) { ?>
					<div class="autoz_topcurloc">
						...
						<?php }else{ ?>
							<?php echo JText::_('CUR_LOC'); ?> : <a anchor="anchor" href="index.php?option=com_jsautoz&view=buyer&layout=controlpannel&Itemid=<?php echo $this->Itemid ; ?>"><?php echo JText::_('CONTROL_PANEL'); ?></a> > <?php echo JText::_('VEHICLE_BY_MODEL_YEAR'); ?>
						<?php }	?>
					</div>
				<?php } ?>
            </div>
			...
			<div id="autoz_topheading">
				<span id="autoz_topheading_text">
					...
					<span id="autoz_topheading_text_center"><?php echo JText::_('VEHICLE_BY_MODEL_YEAR'); ?></span>
    ...
    <div id="jsautoz_wraper">
        <div id="auto_vmakestitle">
            ...
            <table style="background-color: #F9FAF9" cellpadding="0" cellspacing="0" border="" width="100%" >
                ...
                <?php if(isset($this->vehiclebymodelyear)) 
                        foreach($this->vehiclebymodelyear AS $model) { ?>
                    <td >
                        <?php
                        $lnks = 'index.php?option=com_jsautoz&view=buyer&layout=listvehicles&mod='.$model->modelid.'&cl=4&Itemid='.$this->Itemid;
                        ?>
                        <a anchor="anchor" href="<?php echo $lnks ; ?>" >
                            <?php echo $model->modyear.'(<b>'.$model->totalvehiclelbymodelyear.'</b>)';?>
                        </a>
                    </td>
