...
class JHTMLAdsmanagerGeneral
{
	...
	function endTemplate() {
		/*TAG*/echo '<div style="text-align:center !important;"><a href="http://www.joomprod.com" title="'.JText::_('ADSMANAGER_CLASSIFIED_SOFTWARE').'">'.JText::_('ADSMANAGER_CLASSIFIED_SOFTWARE').'</a> powered by JoomPROD.com</div>';	
	}
}